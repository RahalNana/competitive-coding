...
public class HashCode 
{
	...
	{
		public int id, books, signup, rate;
	...
	{
//		Scanner in = new Scanner(new File("E:\\Code\\HashCode 2020\\a_example.txt"));
		Scanner in = new Scanner(new File("E:\\Code\\HashCode 2020\\b_read_on.txt"));
		int b = in.nextInt();
		int l = in.nextInt();
		int d = in.nextInt();
...
//			System.out.println(library.avgDaily);
		...
		FileWriter writer = new FileWriter("E:\\Code\\HashCode 2020\\output_b.txt");
